      ...
      <div className="p-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-8">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h3 className="text-xl font-bold text-primary">{subscription.plan === 'basic' ? 'Plano Básico' : 
                subscription.plan === 'professional' ? 'Plano Profissional' : 'Plano Empresarial'}</h3>
